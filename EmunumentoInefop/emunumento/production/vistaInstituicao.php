...
$pegaIdInstituicao = $_GET['pegaIdIsti'];
$peganomeInstitui = $_GET['nomeInstitui'];
       ...
       <div class="top_nav">
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                      <img src="images/INEFOP.jpg" alt=""><?php echo  $_SESSION['nome'];?>
                    </a>
        ...
        <!-- /top navigation -->
         <div class="alert-success  " align="center">
                  ...
                  <h5>  <strong> <?php echo  $peganomeInstitui;?></strong> </h5>
                    <br>    
                  </div>
        <!-- page content -->
        <div class="right_col" role="main">
          ...
          <div class="tile_count">
            <div class="col-md-2 col-sm-4  tile_stats_count">
             ...
             $nomeEstado = "Avariado";
             $pdo=conectar();
             $dado = $pdo->prepare("SELECT SUM(qtd) AS qtd FROM `emun` WHERE estado='$nomeEstado' and 	instituicao_idinstituicao = '$pegaIdInstituicao'"); 
...
?>
            ...
            <div class="col-md-2 col-sm-4  tile_stats_count">
             ...
             $pdo=conectar();
             $dado = $pdo->prepare("SELECT SUM(qtd) AS qtd FROM `emun` where instituicao_idinstituicao = '$pegaIdInstituicao'"); 
             $dado->execute(array($nomeEstado)); 
             while ($row = $dado->fetch(PDO::FETCH_ASSOC)) { 
             $qtdTotal = $row["qtd"]; 
...
?>
            ...
            <div class="col-md-2 col-sm-4  tile_stats_count">
             ...
             $pdo=conectar();
             $dado = $pdo->prepare("SELECT COUNT(*) AS count FROM `instituicao` where 	idinstituicao = '$pegaIdInstituicao'"); 
             $dado->execute(array($nomeEstado)); 
             while ($row = $dado->fetch(PDO::FETCH_ASSOC)) { 
              ...
              <div class="dashboard_graph">
                ...
                <div class="row x_title" align="center">
                  <div class="col-md-6" align="center">
                    <h3 align="center">Gráficos sobre <small>o estado dos Computadores</small></h3>
                  </div>
                ...
                <div class="col-md-3 col-sm-3  bg-white">
                  <div class="x_title">
                    <h2>Estatistica dos PCs</h2>
                    <div class="clearfix"></div>
                  </div>

                  <div class="col-md-12 col-sm-12 ">
                    <div>
                        <p>Avariados <?php echo round(100*$qtdAvariado/$qtdTotal) ." %"; ?></p>
                      <div class="">
                  ...
                  <div class="col-md-12 col-sm-12 ">
                    ...
                    <div>
                        <p>Funcionais <?php echo round(100*$qtdFuncionais/$qtdTotal)." %"?></p>
                      <div class="">
                        <div class="progress progress_sm" style="width: 100%;">
                      ...
                      <tfoot>
                        <tr align="center">
                          ...
                          <th><?php 
                                    ...
                                    echo   $dados->pegaPcAvariados();
                          
                          
                          ?></th>
                         
                          
                          <th><?php echo   $dados->pegaPcFuncionais($nomeEstado);?></th>
                          <th><?php echo   $dados->pegaPcTotal();?></th>
                        </tr>
                      </tfoot>
                        </tbody>
                    </table>
