...
?>
            ...
            <div class="col-md-12 col-sm-12 ">
              <div class="dashboard_graph">
                ...
                <div class="col-md-3 col-sm-3  bg-white">
                  <div class="x_title">
                      <strong style="color: blue">Estatística dos PCs Por Persentagem</strong>
                    <div class="clearfix"></div>
                  </div>

                  <div class="col-md-12 col-sm-12 ">
                    <div>
                        <p style="color: red">Avariados <?php echo round(100*$qtdAvariado/$qtdTotal)." %"; ?></p>
                      <div class="">
                    ...
                    <div>
                        <p style="color: blue">Reparados</p>
                      <div class="">
                        <div class="progress progress_sm" style="width: 100%;">
                          <div class="progress-bar bg-blue" role="progressbar" data-transitiongoal=<?php echo 100*$qtdReparado/$qtdTotal?>></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12 col-sm-12 ">
                    ...
                    <div>
                        <p style="color: green">Funcionais <?php echo round(100*$qtdFuncionais/$qtdTotal) ." %"?></p>
                      <div class="">
                        <div class="progress progress_sm" style="width: 100%;">
        ...
        <!-- Area da tebela -->
         ...
         <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabela das Unidade formativas da provincia de  Luanda</h2>
        ...
        ?>
                        <tr>
                         ...
                         <td align="center"><a class="dropdown-item" href="vistaInstituicao.php?pegaIdIsti=<?php echo $idinstituicao;?>&nomeInstitui=<?php echo $intituicao;?>"><?php echo $dados->pegaPcNovosPorUnidade($idinstituicao);  ?></a></td>
