            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="../app/Model/interacao.php">
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name" >Nome da Provincia <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="first-name" name="NomeProvincia" required="required" class="form-control ">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Sigla <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="last-name" name="siglaProvincia" required="required" class="form-control">
                        </div>
                      </div>
                  ...
                  <input class="btn btn-primary submit" type="submit" value="Cadastrar Provincia" name="cadastrarProvincia">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings" align="center">
                            ...
                            <th class="column-title">Nome das Provincias </th>
